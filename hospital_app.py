...
div.stButton > button {
    ...
    box-shadow: 0 4px 14px rgb(135, 135, 218) !important;
}
...
DEPT_INFO = {
    ...
    'Gastroenterology': {
        ...
        'desc': "Specialises in digestive system and abdominial conditions.",
    ...
    'Neurology': {
        ...
        'desc': "Handles general health concerns and non-specilaist conditions.",
